...
3. Connect Gmail and Calendar through Google OAuth so it can triage email and manage your schedule.
4. Optionally link WhatsApp (invite-only, needs a dedicated eSIM) once you are set up.
